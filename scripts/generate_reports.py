...
def append_report_body(body, lab):
    ...
    insert(paragraph(
        f"Удалите серые подсказки, проверьте подписи и читаемость доказательств. Сохраните один файл: {lab['recommendedFileName']}. Затем прикрепите его к заданию лабораторной работы № {lab['number']} в Moodle и убедитесь, что отправка завершена.",
        size=20,
        after=80,
    ))
